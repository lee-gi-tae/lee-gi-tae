...
import { faHeart as fasHeart, faMoon, faSun, faGlobe, faTriangleExclamation, faDollarSign, faBuildingColumns, faChartLine } from '@fortawesome/free-solid-svg-icons'
import { faHeart as farHeart } from '@fortawesome/free-regular-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'

// particles.js는 이제 index.html에서 CDN으로 로드됩니다

library.add(fasHeart, farHeart, faMoon, faSun, faGlobe, faTriangleExclamation, faDollarSign, faBuildingColumns, faChartLine)
